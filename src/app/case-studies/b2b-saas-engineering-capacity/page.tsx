  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── Why the normal options were not good enough ── */}
        <section className="section" aria-labelledby="options-h">
          <div className="wrap">
            ...
            <div style={{ ...s.max }} data-reveal>
              <p style={{ ...s.text, marginBottom: "24px" }}>
        ...
        {/* ── What leadership was actually trying to protect ── */}
        ...
        {/* ── Why Build, Operate, Scale mattered here ── */}
